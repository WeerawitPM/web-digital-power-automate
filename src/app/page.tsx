  ...
  return (
    <main className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6 py-5 min-h-screen">
      ...
      <div className="flex flex-row flex-wrap justify-center gap-10">
        ...
        <CardComponent href={`/documents/QF-ITC-0002`} src={"/images/default.png"} document="QF-ITC-0002" title="แบบคำร้องแจ้งซ่อมอุปกรณ์สารสนเทศ" />
        ...
        <CardComponent href={`/documents/QF-ITC-0004`} src={"/images/default.png"} document="QF-ITC-0004" title="แบบฟอร์มใบทะเบียนประวัติอุปกรณ์สารสนเทศ" />
        ...
        <CardComponent href={`/documents/QF-ITC-0008`} src={"/images/default.png"} document="QF-ITC-0008" title="แบบฟอร์มตรวจเช็คเซิฟเวอร์ประจำเดือน" />
